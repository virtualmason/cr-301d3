...
// With the word  function it is the object
// 2. What is "this" when joe.scopeArrow() is invoked?
// When a arrow function is used it's the window object
// 3. Explain why "this" is different when an arrow function is used.
//Becuase arrow functions have no scope so the object that contains them is the scope if the function it is contained in is a arrow or it is not contained the window object will be the scope so this will refer to the window object.
